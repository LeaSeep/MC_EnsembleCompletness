...
ui<-navbarPage(
  ...
  tabPanel(
    ...
    pageWithSidebar(
      ...
      sidebarPanel(
        ...
        checkboxInput("Paper_Plotting",label=c("Paper Plotting?"),value=TRUE),
        checkboxInput("MarginalHist",label=c("Marignal Plots?"),value=TRUE),
  ...
  tabPanel("Density Maps",
           sidebarPanel(
             checkboxInput("splitPerCondition",label=c("Split Per condition?"),value=TRUE),
             checkboxInput("DotsOnTop",label=c("With Dots on Top?"),value=TRUE),
             checkboxInput("MarginalHist2",label=c("Marignal Plots?"),value=TRUE),
             uiOutput("slider1"),
             uiOutput("slider2"),
             uiOutput("slider3"),
             uiOutput("slider4"),
